...
export const getPost = (req, res) => {
  ...
  .then((returnedPost) => {
    res.json({ id: returnedPost._id, title: returnedPost.title, author: returnedPost.author, tags: returnedPost.tags, content: returnedPost.content, cover_url: returnedPost.cover_url });
  })
  .catch((err) => {
    res.json({ err });
  });
...
export const updatePost = (req, res) => {
  PostModel.findOneAndUpdate({ _id: req.params.id }, { title: req.body.title, author: req.body.author, tags: req.body.tags, content: req.body.content, cover_url: req.body.cover_url })
    .then(() => {
